...
Preencher os dados obrigatórios
    ...
    Input Text                      ${CADASTRO_FORM_FIELDS.nome}          Lucas
    Input Text                      ${CADASTRO_FORM_FIELDS.ultimo_nome}   Araujo
    Input Text                      ${CADASTRO_FORM_FIELDS.senha}         123456
    Input Text                      ${CADASTRO_FORM_FIELDS.endereco}      Rua valdemar Falcao, Bairro Engenho do meio
    Input Text                      ${CADASTRO_FORM_FIELDS.cidade}        Recife
...
Conferir se o cadastro foi efetuado com sucesso
    ...
    Element Text Should Be           ${CADASTRO_USUARIO}    Lucas Araujo
